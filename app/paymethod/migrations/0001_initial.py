    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fee_registration_criteria', models.BooleanField(default=True, verbose_name='수수료등록기준_VAT_포함_or_VAT_미포함')),
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='생성날짜')),
                ('updated_date', models.DateTimeField(auto_now=True, verbose_name='업데이트된날짜')),
                ('paygouser', models.OneToOneField(help_text='유저', on_delete=django.db.models.deletion.PROTECT, related_name='paygouser', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '정산정보',
